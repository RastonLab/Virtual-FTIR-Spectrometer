  ...
  const handleSubmission = () => {
    ...
    while (rawData !== '') {
        ...
        if (line.charAt(0) !== '#') { 
            ...
            dispatch(storeParams({min_wave: parameters[0], max_wave: parameters[1], molecule: parameters[2], pressure: parameters[3], resolution: parameters[4], num_scan: parameters[5], zero_fill: parameters[6], source: parameters[7], beamsplitter: parameters[8], cell_window: parameters[9], detector: parameters[10]}));
        }
